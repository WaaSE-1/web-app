  ...
  let grid = (
    <div className="grid">
      <div className="cars-single-off-column">
          <img width="300" height="180" alt="product-img" className="product-img" src={car?.image_url ? car.image_url : "https://www.autocar.co.uk/sites/autocar.co.uk/files/styles/gallery_slide/public/images/car-reviews/first-drives/legacy/bmw-8-series-805_0.jpg?itok=e--SHpJj"} />
